...
// 响应
{
  code: 1,
  data: {
    payment_url: "https://sandbox-web-pay.line.me/...",
    transaction_id: "20230101000000001",
    order_no: "123456789"
  }
}
...
// 3. 用户在 LINE 完成支付后，页面自动跳转回
// /api/line/order/linePayConfirm?transactionId=xxx&orderId=xxx

// 4. 后端确认扣款并更新订单状态
// 前端跳转到 /#/pages/payment/success?order_id=xxx
